...
#define EHRaiseError(lDataToLog) do { \
    ehEc.fInError = true; \
...
#define EHEmitMsg do { \
    ...
    Serial.print(" 0x"); \
    Serial.print(ehEc.lData, HEX); } while(0);
#endif
