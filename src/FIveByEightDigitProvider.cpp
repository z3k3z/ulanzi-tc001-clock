...
// clang-format off
const uint8_t FiveByEightDigitProvider::_kDigit0Rows[_kGlyphHeight] = {
      0b01110,
      0b10001,
      0b10001,
      0b10011,
...
const uint8_t FiveByEightDigitProvider::_kDigit3Rows[_kGlyphHeight] = {
      0b01110,
      0b10001,
      0b00001,
      0b00110,
...
const uint8_t FiveByEightDigitProvider::_kDigit4Rows[_kGlyphHeight] = {
      0b00010,
      0b00110,
      0b01010,
      0b10010,
...
const uint8_t FiveByEightDigitProvider::_kDigit5Rows[_kGlyphHeight] = {
      0b11111,
      0b10000,
      0b10000,
      0b11110,
...
const uint8_t FiveByEightDigitProvider::_kDigit6Rows[_kGlyphHeight] = {
      0b00110,
      0b01000,
      0b10000,
      0b11110,
...
const uint8_t FiveByEightDigitProvider::_kDigit7Rows[_kGlyphHeight] = {
      0b11111,
      0b00001,
      0b00010,
      0b00010,
...
const uint8_t FiveByEightDigitProvider::_kDigit8Rows[_kGlyphHeight] = {
      0b01110,
      0b10001,
      0b10001,
      0b01110,
...
const uint8_t FiveByEightDigitProvider::_kDigit9Rows[_kGlyphHeight] = {
      0b01110,
      0b10001,
      0b10001,
      0b10001,
...
FiveByEightDigitProvider::FiveByEightDigitProvider() :
...
bool FiveByEightDigitProvider::getDigitFor(unsigned int       uiDigit,
